...
- (void)configPerXAndPerY{
    ...
    _perXLen = (_xLength-kXandYSpaceForSuperView)/([self.xArr count]-1);
    _perYlen = (_yLength-kXandYSpaceForSuperView)/([self.yArr count]);
}
...
- (void)drawXAndYLineWithContext:(CGContextRef)context{
    ...
    CGFloat xPace = (_xLength-kXandYSpaceForSuperView)/(self.xArr.count-1);
