...
@interface JianboViewController ()<UITableViewDelegate,UITableViewDataSource>
@property (nonatomic, strong) UITableView *tableView;
@end


@implementation JianboViewController
...
//        weboneViewController *pic = [[weboneViewController alloc] init];
//        [self.navigationController pushViewController:pic animated:YES];
