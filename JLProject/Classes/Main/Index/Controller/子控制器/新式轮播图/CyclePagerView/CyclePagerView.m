...
@interface CyclePagerView () <TYCyclePagerViewDataSource, TYCyclePagerViewDelegate>
...
- (void)layoutSubviews{
    ...
    _pagerView.frame = CGRectMake(0, 64, CGRectGetWidth(self.frame), 200);
    _pageControl.frame = CGRectMake(0, CGRectGetHeight(_pagerView.frame) - 26, CGRectGetWidth(_pagerView.frame), 26);
}
