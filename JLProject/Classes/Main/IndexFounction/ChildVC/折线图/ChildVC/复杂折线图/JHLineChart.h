...
@interface JHLineChart :JLCircleChart
...
/**
 *  whether this chart shows the point text or not.Default is YES
 */
@property (nonatomic,assign) BOOL showLevePoint;
...
/**
 *  the show animation with duration,default is 2 Second
 */
